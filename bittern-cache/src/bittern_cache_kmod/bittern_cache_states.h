...
enum cache_transition {
	...
	/* NOTE TO REVIEWER: WILL REMOVE THESE COMMENTS IN NEXT RB */
	TS_P_WRITE_HIT_WB_CLEAN, /* OBSOLETED BY NEXT ONE */
	/* CLEAN->DIRTY PARTIAL WRITE HIT, USES CLONING */
...
enum cache_state {
	...
	/* NOTE TO REVIEWER: WILL REMOVE OBSOLETED STATES IN NEXT RB */
	S_DIRTY_P_WRITE_HIT_CPF_CACHE_START, /* OBSOLETED, SEE BELOW */
	S_DIRTY_P_WRITE_HIT_CPT_CACHE_START, /* OBSOLETED, SEE BELOW */
	S_DIRTY_P_WRITE_HIT_CPT_CACHE_END, /* OBSOLETED, SEE BELOW */

	/* NOTE TO REVIEWER: WILL REMOVE THESE COMMENTS IN NEXT RB */
	/* THESE THREE STATES ADD WRITE CLONING FOR PARTIAL WRITE HIT
	 * CASE ON A CLEAN BLOCK */
