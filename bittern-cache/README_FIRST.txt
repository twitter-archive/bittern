...
thisdir $                          cd src/
thisdir/src $                      make distclean
thisdir/src $                      make devconfig
thisdir/src $                      make
thisdir/src $                      cd bittern_cache_kmod
thisdir/src/bittern_cache_kmod $   make doxygen.docs
thisdir/src/bittern_cache_kmod $   firefox doxygen.docs/html/index.html
