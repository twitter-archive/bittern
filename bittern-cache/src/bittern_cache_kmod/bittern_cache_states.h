...
enum cache_transition {
	 ...
	 */
	TS_WRITE_HIT_WB_CLEAN, /* OBSOLETED BY WRITE CLONING */
	TS_WRITE_HIT_WB_CLEAN_DWC_CLONE, /* OBSOLETES THE ABOVE */
...
enum cache_state {
	 ...
	 * WHICH WILL REMOVE OBSOLETE CODE AFTER WRITE CLONING IS COMPLETE.
	 */
	S_DIRTY_WRITE_HIT_CPT_CACHE_START, /* OBSOLETED BY WRITE CLONING */
	S_DIRTY_WRITE_HIT_CPT_CACHE_END, /* OBSOLETED BY WRITE CLONING */
	/*
	 * THE NEXT TWO STATES REPLACE THE PREVIOUS TWO ONES
	 */
