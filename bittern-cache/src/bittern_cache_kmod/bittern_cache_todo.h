 ...
 *
 * The following National Wildlife (NWR) Refuges are among the author's favorite
 * wetlands, which is the natural habitat for the Bittern:
 *
 *
 * Ridgefield NWR, Ridgefield, WA:
 * 	http://www.fws.gov/refuge/Ridgefield/
 * Julia Butler Hansen NWR, Cathlamet, WA:
 *	http://www.fws.gov/refuge/julia_butler_hansen/wildlife_and_habitat.html
 * El Bosque Del Apache NWR, Socorro, NM:
 *	http://www.fws.gov/refuge/Bosque_del_Apache/
 * Klamath NWR Complex, Klamath Falls, OR:
 *	http://www.fws.gov/klamathbasinrefuges/
 *	http://www.fws.gov/refuge/Lower_Klamath/
 * Sacramento NWR Complex, Sacramento, CA:
 *	http://www.fws.gov/refuge/Sacramento/
 *	http://www.fws.gov/refuge/Sacramento/WildlifeandHabitat.html
 *
 */
