...
#define INVALIDATOR_MIN_INVALID_COUNT CACHE_DEFAULT_MAX_PENDING_REQUESTS
#define INVALIDATOR_DEFAULT_INVALID_COUNT (CACHE_DEFAULT_MAX_PENDING_REQUESTS * 2)
#define INVALIDATOR_MAX_INVALID_COUNT CACHE_MAX_MAX_PENDING_REQUESTS
