 ...
 */
#define CACHE_INVALIDATOR_MIN_INVALID_COUNT \
	(CACHE_MAX_MAX_PENDING_REQUESTS * 2)

#define CACHE_INVALIDATOR_DEFAULT_INVALID_COUNT \
	(CACHE_INVALIDATOR_MIN_INVALID_COUNT + 4000)

#define CACHE_INVALIDATOR_MAX_INVALID_COUNT \
	(CACHE_INVALIDATOR_MIN_INVALID_COUNT + 10000)
 ...
 */
#define CACHE_INVALIDATOR_THREAD_NICE -20
